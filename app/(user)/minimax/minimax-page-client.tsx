...
interface MinimaxPageClientProps {
  initialVoices: Voice[]
}

export function MinimaxPageClient({ initialVoices }: MinimaxPageClientProps) {
  ...
  return (
    <div className="pb-20 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">MiniMax 声音服务</h1>
          <p className="text-muted-foreground">
            使用 MiniMax API 克隆声音和生成语音
          </p>
        </div>
