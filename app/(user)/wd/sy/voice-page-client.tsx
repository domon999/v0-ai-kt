...
export function VoicePageClient() {
  const [text, setText] = useState('你好，欢迎使用MiniMax语音合成。这是一段测试文本，用于验证语音合成功能是否正常工作。')
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="mx-auto max-w-4xl space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">MiniMax 语音合成</h1>
          <p className="mt-1 text-muted-foreground">
            可自定义 API Key 或使用 /glht/api 中的配置
          </p>
        </div>
